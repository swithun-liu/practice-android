...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 820909828;
...
fn wire__crate__api__simple__init_smbconnect_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse((move || {
                Result::<_, ()>::Ok(crate::api::simple::init_smbconnect())
            })())
        },
    )
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__simple__init_smbconnect_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
